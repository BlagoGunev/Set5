...
public class SierpinskiTrianglePanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			GradientPaint paint = new GradientPaint(0, 0, Color.BLUE, getWidth(), getHeight(), Color.CYAN, true);
		...
		private static void displayTriangles(Graphics g, int order, Point p1, Point p2, Point p3) {
			if (order == 0) {
				...
				Polygon tr = new Polygon(new int[]{p1.x, p2.x, p3.x}, new int[]{p1.y, p2.y, p3.y}, 3);
				g.fillPolygon(tr);
